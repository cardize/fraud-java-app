 ...
 * stays the same.
 *
 * Active when: fraud.ai.enabled=true (default). If false, {@link NoOpAnomalyDetector} takes over.
 */
@Component
@ConditionalOnProperty(name = "fraud.ai.enabled", havingValue = "true", matchIfMissing = true)
